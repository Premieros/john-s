  ...
  return (
    <DesignSurface>
      ...
      <div className="space-y-4">
        ...
        <DesignPanel title={isAr ? 'طلبات الموافقة' : 'Approval Requests'}>
        ...
        <DesignPanel title={isAr ? 'ما الذي يحتاج موافقة ومن يديره' : 'Approval Rules & Responsible Manager'}>
        ...
        <DesignPanel title={isAr ? 'السجل' : 'History'}>
