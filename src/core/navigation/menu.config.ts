...
export const MENU_ITEMS: MenuItemConfig[] = [
  ...
  { id: 'approvals', route: APP_ROUTES.approvals, icon: 'settings', labelKey: 'settings', label: { ar: 'مركز الموافقات', en: 'Approval Center' }, permission: 'settings.manage', group: 'admin' },
