...
- قبل أول بيع فعلي يجب مراجعة عقد `inventory_units/product_unit_links` لأن النظام الحالي يشترط وحدات مخزون لكل منتج قابل للبيع، بينما البيانات المستوردة حتى الآن ركزت على الكتالوج + raw materials + recipes ولم تنشئ inventory units تلقائياً.
