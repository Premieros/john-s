...
### الأولوية التالية
1. إكمال Cashier/Manager E2E وباقي تحسينات الموافقات.
2. استكمال P2 security audit المحدود للضرائب/الخصومات/الوحدات/الكميات.
3. Purchase UOM conversion audit قبل اعتماد E2E مشتريات حقيقي.
